...
def trainFromCSV(csvName,outputFolder,neuron_num):
    ...
    model.add(Dense(neuron_outer, kernel_initializer='normal', activation='relu'))
    model.add(Dense(neuron_mid, kernel_initializer='normal', activation='relu'))
    model.add(Dense(neuron_outer, kernel_initializer='normal', activation='relu'))
